...
CKEDITOR.plugins.add("wordcount", {
    ...
    init: function (editor) {
        ...
        var defaultConfig = {
            ...
            charCountGreaterThanMaxLengthEvent: function (currentLength, maxLength) { console.log('more'+currentLength);
            ...
            charCountLessThanMaxLengthEvent: function (currentLength, maxLength) { console.log('less');
       ...
       function counterId(editorInstance) {
        ...
        editor.on("paste", function(event) {
            ...
            if (config.maxWordCount > 0 || config.maxCharCount > 0) {
                ...
                if(text.length > config.maxCharCount) {
                    var text = text.substring(0,config.maxCharCount);
                }
                else {
                    var text = text;
                }
