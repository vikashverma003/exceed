...
/*                $.each(data.data,function(index, el) {
                ...
                $("#title_td").html('<span class="fa fa-square" style="color:'+data.data.hexacode+'"></span>'+data.data.title)
                $("#hexacode_td").html(data.data.hexacode)
                $("#description_td").html(data.data.description)
    ...
    $(document).on('click','.edit-contract', function(e){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.minicolors-swatch-color').css("background-color",data.data.hexacode);
