                    ...
                    <div class="col-md-6">
                        <div class="form-body">
                            <div class="form-group user_role">
                                ...
                                <input type="text" name="user_role" class="form-control" placeholder="Enter Role">
                                <span class="error"></span>
                            </div>
                        </div>
                    </div></div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="form-group comment">
                                ...
                                <textarea name="comment" class="form-control" placeholder="Enter Description"></textarea>
                                <span class="error"></span>
                            </div>
                        </div>
                    </div></div>
                     ...
                     <div class="col-md-6">
                        <div class="form-body">
                            <div class="form-group user_image">
                                <label>Image (Type: jpeg, png, jpg) Max Size:2MB, Preferred Size: 100*100</label><span style="color: red;"> *</span>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            $.ajax({
                url: "{{url('admin/testimonials')}}", //url
