...
<ul class="page-breadcrumb breadcrumb">
    <li>
        ...
        <i class="fa fa-circle"></i>
        <a href="{{ url('admin/categories') }}">Training Categories Listing</a>
    </li>
</ul>
<!-- END PAGE HEADER-->
<div class="row">
                ...
                <form role="form" method="POST" name="add_form" id="add_form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-body">
                                <div class="form-group color">
                                    ...
                                    <input type="text" name="color" class="form-control" id="colorpicker-popup">
                                    <span class="error"></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-preview thumbnail" style="max-width: 200px; max-height: 150px; line-height: 10px;">
                                    <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt="Icon" style="width: 200px; height: 150px;" class="icon_prev">
                                </div>
                            </div>
                        </div>
                    </div>
