...
@section('title', 'Edit Company Logo')
@section('content')
<!-- BEGIN PAGE HEADER-->
<div class="page-head">
...
<ul class="page-breadcrumb breadcrumb">
    <li>
       <i class="fa fa-circle"></i>
        ...
        <i class="fa fa-circle"></i>
        <a href="{{ url('admin/companylogos') }}">Companies Logo Listing</a>
    </li>
</ul>
<!-- END PAGE HEADER-->
<div class="row">
            ...
            <div class="portlet-body form">
                <form role="form" method="POST" name="add_form" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="form-group logo">
                                <label>Logo (Type: jpeg, png, jpg, gif, svg) Max Size:2MB</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    @else
                                        <img src="{{asset('uploads/companieslogo/'.$data->logo)}}" alt="Logo" style="width: 200px; height: 150px;" class="image_prev">
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{url('admin/companylogos')}}"><button type="button" class="btn default">Cancel</button></a>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            var id = "{{$data->id}}";
            $.ajax({
                url: "{{url('admin/companylogos')}}"+'/'+id, //url
