...
@section('title', 'Edit Training Site Content')
@section('content')
<!-- BEGIN PAGE HEADER-->
<div class="page-head">
    <div class="page-title">
        <h1>
            Edit Training Site Content
        </h1>
    </div>
</div>
                            ...
                            <div class="form-group type">
                                ...
                                <select name="type" class="form-control">
                                    @foreach($locations as $row)
                                        <option value="{{$row->name}}" @if($content->key==$row->name) @endif>{{$row->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-body">
                            <div class="form-group content">
                                ...
                                <textarea name="content" id="content" class="form-control" placeholder="Enter content">{{$content->value}}
                                </textarea>
                                <span class="error"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            $.ajax({
                url: "{{url('admin/settings/training-site/update')}}", //url
