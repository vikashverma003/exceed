<form name="filter_listing" style='overflow-x: auto;'>
	<table class="table table-striped table-bordered table-hover dataTable no-footer" id="datatable_ajax" aria-describedby="datatable_ajax_info" role="grid">
		<thead>
			...
			<tr role="row" class="filter">
				...
				<td rowspan="1" colspan="1">
					<input type="text" class="form-control form-filter input-sm" name="company_name" id="company_name" placeholder="company name">
				</td>
				<td rowspan="1" colspan="1">
					<input type="text" class="form-control form-filter input-sm" name="course" id="course" placeholder="Course">
				</td>
				<td rowspan="1" colspan="1"></td>
				<td rowspan="1" colspan="1">
