...
<ul class="page-breadcrumb breadcrumb">
    <li>
        ...
        <i class="fa fa-circle"></i>
        <a href="{{ url('admin/servicecards') }}">Cards Content Listing</a>
    </li>
</ul>
<!-- END PAGE HEADER-->
<div class="row">
            ...
            <div class="portlet-body form">
                <form role="form" method="POST" name="add_form" id="add_form" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-body">
                            <div class="form-group card_number">
                                <label>Card</label>&nbsp;<span style="color: red;">*</span>
                                <select name="card_number" class="form-control">
                                    @if($data->card_number==1)
                                        <option value="1" >{{$cms->service_card_1_title}}</option>
                                    @elseif($data->card_number==2)
                                        <option value="2" readonly>{{$cms->service_card_2_title}}</option>
                                    @elseif($data->card_number==3)
                                        <option value="3" readonly>{{$cms->service_card_3_title}}</option>
                                    @endif
                                </select>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{url('admin/servicecards')}}"><button type="button" class="btn default">Cancel</button></a>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            var id = "{{$data->id}}";
            $.ajax({
                url: "{{url('admin/servicecards')}}"+'/'+id, //url
