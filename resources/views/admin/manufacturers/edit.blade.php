                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    @else
                                        <img src="{{asset('uploads/manufacturers/'.$data->logo)}}" alt="Logo" style="width: 200px; height: 150px;" class="image_prev">
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    @else
                                        <img src="{{asset('uploads/manufacturers/'.$data->banner)}}" alt="Logo" style="width: 200px; height: 150px;" class="banner_prev">
                                    @endif
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            var id = "{{$data->id}}";
            $.ajax({
                url: "{{url('admin/manufacturers')}}"+'/'+id, //url
