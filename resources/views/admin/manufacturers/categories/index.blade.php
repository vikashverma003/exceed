...
@section('title', 'Manufacturer\'s Categories')
...
<div class="page-head">
    <div class="page-title">
        <h1>
            Manage Manufacturer's Categories
        </h1>
    </div>
</div>
                    ...
                    <div class="col-md-12">
                        <div class="form-body">
                            <div class="form-group categories">
                                <label> Training Categories</label>&nbsp;<span style="color: red;">*</span>
                                <select data-placeholder="Choose a category..." multiple class="form-control chosen-select" name="categories[]" id="categories">
                                    @foreach($categories as $row)
                                        @php
                                            $selected = '';
                                            if(in_array($row->id, $assign))
                                                $selected = 'selected';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("form[name='add_form']").submit(function(e){
            ...
            if(categories == null)
            {
                $(document).find('span.error').html("Please select atleast one category");
                return false;
            }
            ...
            $.ajax({
                url: "{{url('admin/manufacturer-categories')}}", //url
