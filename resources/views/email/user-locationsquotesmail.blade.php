...
<body>
	<div style="width: 75%; margin: 20px auto;">
	    ...
	    <p style="margin-top:0pt; margin-bottom:0pt; font-size:14.5pt;">
	    	<br>
	    	<span style="font-family:Hero; color:#3d4852;">Hello</span>
	    	<span style="font-family:Hero; color:#3d4852;">{{ucfirst($data['first_name'])}}</span>
	    	<span style="font-family:Hero; color:#3d4852;">!</span>
	    </p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Thanks for showing interest in our services. We will get back to you ASAP. This is an acknowledgment of the query you submitted to us using our quote form.</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">You have provided the below details:&nbsp;</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Name: {{$data['first_name']}} {{$data['last_name']}}</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Email:</span><span style="font-family:Cambria; font-size:12pt; color:#3d4852;">&nbsp;</span><a href="mailto:mohamad.khasrow@gmail.com" style="text-decoration:none;"><u><span style="font-family:Hero; font-size:12pt; color:#0000ff;">{{$data['email']}}</span></u></a></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Phone: {{$data['country_code'] ?? ''}} - {{$data['phone']}}</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Address: {{$data['city'] ?? ''}}, {{$data['state'] ?? ''}}, {{$data['country'] ?? ''}} - {{$data['zipcode']}}</span><span style="font-family:Cambria; font-size:12pt; color:#3d4852;">&nbsp;</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Message: {{$data['message']}}</span></p>
	    <p style="margin-top:0pt; margin-bottom:14pt; line-height:18pt;"><span style="font-family:Hero; font-size:12pt; color:#3d4852;">Company Name: {{$data['company_name']}}</span></p>
			    ...
			    <table cellpadding="0" cellspacing="0" style="width:100%; border:1pt solid #000000; border-collapse:collapse;">
			        <tbody>
			            <tr style="height:15.75pt;">
			                <td colspan="4" style="border-right-style:solid; border-right-width:1pt; border-bottom-style:solid; border-bottom-width:1pt; padding:1pt 1.75pt; vertical-align:bottom; background-color:#d9d9d9;">
			               ...
			               <!--  <td style="width:34.65pt; border-bottom-style:solid; border-bottom-width:1pt; vertical-align:top; background-color:#d9d9d9;border-right-style: solid;border-right-width: 1pt;">
			                    <p style="margin-top:0pt; margin-bottom:0pt; font-size:8pt;"><span style="font-family:Hero;">Timezone</span></p>
			                </td> -->
			                <td style="width:34.65pt; border-bottom-style:solid; border-bottom-width:1pt; vertical-align:top; background-color:#d9d9d9;">
			            ...
			            <tr style="height:15.75pt;">
			                ...
			                <td style="border-right:1pt solid #dee2e6; border-bottom:1pt solid #dee2e6; padding:1.5pt 1.75pt 1pt 2.25pt; vertical-align:bottom; background-color:#f3f3f3;">
			                 ...
			                 <td style="border-right:1pt solid #dee2e6; border-bottom:1pt solid #dee2e6; padding:1.5pt 1.75pt 1pt 2.25pt; vertical-align:bottom; background-color:#f3f3f3;">
			                    <p style="margin-top:0pt; margin-bottom:0pt; font-size:8pt;"><span style="font-family:Hero; color:#212529;">Timezone</span></p>
			                </td>
			                <td style="border-right:1pt solid #dee2e6; border-bottom:1pt solid #dee2e6; padding:1.5pt 1.75pt 1pt 2.25pt; vertical-align:bottom; background-color:#f3f3f3;">
			               ...
			               <!--  <td style="width:50.5pt; border-right-style:solid; border-right-width:1pt; border-bottom:1pt solid #dee2e6; padding:1.5pt 1.75pt 1pt 2.25pt; vertical-align:bottom; background-color:#f3f3f3;">
			                ...
			                <td style="width:34.65pt; border-bottom:1pt solid #dee2e6; vertical-align:top; background-color:#f3f3f3;">
			            ...
			            @foreach(@$subarr as $row)
				            <tr style="height:15.75pt;">
				               ...
				               <!--  <td style="width:50.5pt; border-right-style:solid; border-right-width:1pt; border-bottom:1pt solid #cccccc; padding:1.5pt 1.75pt 1pt 2.25pt; vertical-align:top;">
				                    <p style="margin-top:0pt; margin-bottom:0pt; font-size:8pt;"><span style="font-family:Hero; color:#212529;">{{$row['timezone'] ?? ''}}</span></p>
				                </td> -->
				                <td style="width:34.65pt; border-bottom:1pt solid #cccccc; vertical-align:top;">
